...
Route::post('opd/show','OpdController@show')->name('opd-show');
Route::post('opd/add','OpdController@addtreatment')->name('opd-add');
...
//blood routes
Route::get('bloodexamination/create','BloodexaminationController@create')->name('blood-create');
