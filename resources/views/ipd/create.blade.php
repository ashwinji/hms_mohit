						...
						<div class="row">
							<div class="offset-md-2 col-md-4">
								<div class="form-group">
									...
									{!! Form::text('patientId', '',['class' => 'form-control opd',
									'placeholder' => 'Enter OPD Registration Number','id'=>'patientId',]) !!}
							...
							<div class="col-md-4 ">
								...
								{!! Form::date('opdDate', '',['class' => 'form-control','placeholder' => 'Enter OPD Date',
							...
							<div class="offset-md-2 col-md-4">
								<div class="form-group">
									...
									{!! Form::text('ipdRegNum','',['class' => 'form-control',
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									{!! Form::date('ipdRegDate','',['class' => 'form-control','placeholder' => 'Enter Registration Date'
									]) !!}
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									{!! Form::text('otherConsultant', '',['class' => 'form-control','id'=>'otherConsultant','name'=>'otherConsultant','readonly' => 'true',
							...
							<div class=" offset-md-2 col-md-4">
								...
								'placeholder' => 'Enter Patient Name','id'=>'patientName','name'=>'patientName','readonly' => 'true',]) !!}
							...
							<div class="col-md-4">
								<div class="form-group">
								{!! Form::label('name', 'Age') !!}
								{!! Form::text('age', '',['class' => 'form-control','placeholder' => 'Enter Age' ,'id'=>'age','name'=>'age','readonly' => 'true',]) !!}
							...
							<div class="offset-md-2 col-md-4">
								...
								{!! Form::select('medicine2',$medicine,'', ['class' => 'form-control','id'=>'medicine2','placeholder'=>'select medicine2']) !!}
								</div>
							</div>
							<div class=" col-md-4">
								<div class="form-group">
