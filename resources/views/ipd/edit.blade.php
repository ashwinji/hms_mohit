        ...
        <div class="col-lg-12">
            <div class="card" >
                <div class="card-header">
                   ...
                   <div class="card-body">
                      <div class="btn-list" style="float: right;">
                            <a href="{{route('ipd-filter')}}" class="btn btn-xs btn-success">Show / Search Old IPD Patients 
                            </a>
                      </div>
                  </div>
              </div>
                <div class="card-body">
                        ...
                        {!! Form::open(array('route'=>['ipd.update',$ipd->id],'files'=>'true','id'=>'opd-form', 'method'=>'PUT','autocomplete'=>'off')) !!}
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                 ...
                                 {!! Form::select('wardName', ['L' => 'Large', 'S' => 'Small', 'Sz' => 'Smallz',], $ipd->wardName, ['class' => 'form-control','id'=>'wardName','name'=>'wardName']) !!}
                            </div>
                         </div>
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                 ...
                                 <div style="margin-left: 20px;">
                                    {!! Form::radio('bedNum', $ipd->bedNum, ['class' => 'form-control','id'=>'bedNum1']) !!}
                                    {!! Form::label('name', '1') !!}
                    ...
                    <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('localExamination',  null, ['class' => 'form-control','placeholder' => 'localExamination','rows' => 3, 'cols' => 10,]) !!}
                            </div>
                         </div>
                                   ...
                                   <div class="row"> 
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            {!! Form::label('dietPlan1', 'dietPlan<span class="badge badge-success control-label">1</span>',[],false) !!}
                                            {!! Form::textarea('diet1Text',  null, ['class' => 'form-control','placeholder' => 'Diet 1 Plan Text','rows' => 3, 'cols' => 10,      ]) !!}
                                        </div>
                                       </div> 
                                     ...
                                     <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('dietPlan1', 'dietPlan<span class="badge badge-success control-label">2</span>',[],false) !!}
                                            {!! Form::textarea('diet2Text',  null, ['class' => 'form-control','placeholder' => 'Diet 2 Plan Text','rows' => 3, 'cols' => 10,      ]) !!}
                                        </div>
                                     </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('remark',  null, ['class' => 'form-control','placeholder' =>' Remarks','rows' => 3, 'cols' => 10,]) !!}
                                        </div>
                                    </div>
                                </div>
                           </div>
