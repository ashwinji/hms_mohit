                ...
                <div class="expanel expanel-default mt-4">
                    <div class="expanel-body">
                         <span data-dismiss="modal" class="pull-right" style="margin-right: 50px !important;"><a href=""><b>X</b></a></span>
                          ...
                          </span> <i  onclick="printDiv('Opd patient Card','opdview')" class=" pull-right fa fa-print btn btn-square btn-info" style="margin-right: 10px;"> 
...
<table class="table table-bordered table-striped table-hovered  col-md-12" id="opdview">
                <thead>
                    <tr>
