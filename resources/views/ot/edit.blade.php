            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        ['class' =>'form-control','name'=>'patientName','readonly'=>'true','id'=>'patientName']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        ['class' =>'form-control','id'=>'gender','name'=>'gender','readonly'=>'true','placeholder'=>'GENDER']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        ['class' =>'form-control','id'=>'address','readonly'=>'true']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        => 3, 'cols' =>40,'placeholder'=>'otprocessre']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        $ot->consultant,['class' =>'form-control','id'=>'consultant','name'=>'consultant'])!!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        ['class' =>'form-control','id'=>'otherConsultant','name'=>'otherConsultant'])!!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        'id'=>'adviceTreatment','name'=>'adviceTreatment','rows' => 3, 'cols' =>40,'placeholder'=>'adviceTreatment']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        $ot->medicine1,['class' =>'form-control','id'=>'medicine1','name'=>'medicine1'])
                        !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group">
                        {!! Form::select('medicine1',$medicine,
                        $ot->medicine2,['class' =>'form-control','id'=>'medicine2','name'=>'medicine2']) !!}
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                        <div class="form-group">
                        {!! Form::select('medicine1',$medicine, $ot->medicine3,
                    ...
                    <div class="row">
                        ...
                        'id'=>'Remark','rows' => 3, 'cols' =>40,'placeholder'=>'Remark','name'=>'Remark'])!!}
                        </div>
                        </div>
                    </div>
                    <center>
                        <button class="btn btn-square btn-success" type="submit">Submit</button>
                        <a href="{{route('ot-create')}}" class="btn btn-square btn-danger" type="">
                        Cancel
                        </a>
                        </button>
                    </center>
