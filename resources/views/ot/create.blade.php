                ...
                <div class="row">
                                ...
                                <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            ,
                                                '',
                                                ['class' =>
                                                'form-control','id'=>'consultant','name'=>'consultant','placeholder'=>'select consultant list'])
                                                !!}
                                        </div>
                                </div>
                        </div>
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                        {!!
                                        Form::textarea('adviceTreatment',null,['class'=>'form-control',
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                        ...
                                        '',
                                        ['class' =>
                                        'form-control','id'=>'medicine1','name'=>'medicine1','placeholder'=>'select medicine 1'])
                                        !!}
                                </div>
                        </div>
                  </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                                ...
                                                '',
                                                ['class' =>
                                                'form-control','id'=>'medicine3','name'=>'medicine3','placeholder'=>'select medicine 3'])
                                                !!}
                                        </div>
                                </div>
                        </div>
