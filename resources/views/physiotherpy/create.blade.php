                ...
                <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        'physiotherpy.store','files'=>'true','class'=>'fixed','id'=>'profile-form','autocomplete'=>'off'))
                                        !!}
                                        <div class="col-md-12">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                                <div class="form-group">
                                                                        ...
                                                                        'form-control','id'=>'referredBy','placeholder'=>'referredBy'])
                                                                        !!}
                                                                </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                                <div class="form-group">
                                                                        {!! Form::text('therapy', '', ['class' =>
                                                                        'form-control','id'=>'therapy','placeholder'=>'AdvicedTherapy','name'=>'therapy'])
                                                                        !!}
                                                                </div>
                                                        </div>
                                                </div>
