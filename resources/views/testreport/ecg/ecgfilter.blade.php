...
<body>
    ...
    <div class="page">
        ...
        <a href="{{route('ecg-create')}}" class="btn btn-xs btn-success"> <i class="fa fa-plus"></i> Add Patients </a>
        <i  onclick="printDiv('ECG EXAMINATION','ecg')" class=" pull-right fa fa-print btn btn-square btn-info" style="margin-right: 10px;"> 
        Print</i> <a href="javascript:void(0);" ></a>
        </div>
        </div>
        <div class="card-body">
        <div class="table-responsive">
        <table id="ecg" class="table table-striped table-bordered w-100">
        <thead>
        <tr>
...
<script type="text/javascript">
    ...
    oTable = $('#ecg').DataTable({
    "processing": true,
    "serverSide": true,
    "ajax": "{{ route('sendecgdata') }}",
    "columns": [
    { data: 'id', name: 'id' },
