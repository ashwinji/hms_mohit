	...
	<div class="page">
									...
									<div class="card">
										<div class="card-header">
											...
											<div class="btn-list" style="float: right;">
												...
												<a href="#" class="btn btn-xs btn-success">Show Stool Examination Pateints List</a>
	        ...
	        {!! Form::textarea('other',  null, ['class' => 'form-control','placeholder' => 'Enter Other','rows' => 3, 'cols' => 10,]) !!}
							    </div>
								</div>
