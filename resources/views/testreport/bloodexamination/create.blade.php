	...
	<div class="page">
						...
						<div class="card-header">
							...
							<div class="card-body">
								<div class="btn-list" style="float: right;">			
									<a href="{{route('blood-filter')}}" class="btn btn-square btn-xs btn-success">Show Blood Examination Pateints List
									</a>	
							   </div>
							</div>
						</div>						
		<div class="card-body">
			...
			<div class="col-md-6" >
				<div class="form-group">
				  <div >
				     <a href="" class="btn  btn-square btn-danger" id="cancel" type="reset">Cancel</a> 
			      </div>
				</div>
			</div>
		  </div>
