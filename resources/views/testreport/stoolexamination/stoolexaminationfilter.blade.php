                         ...
                         <div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"> SERUN FOR WIDAL TEST PATIENTS LIST</div>
								</div>
								<div class="card-body">
                                	<div class="table-responsive">
									<table id="serun" class="table table-striped table-bordered w-100">
										<thead>
...
<script src="{{asset('assets/plugins/datatable/jquery.dataTables.min.js')}}"></script>
    ...
    $(document).ready(function () {
        oTable = $('#serun').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('sendserundata') }}",
            "columns": [
                { data: 'id', name: 'id' },
