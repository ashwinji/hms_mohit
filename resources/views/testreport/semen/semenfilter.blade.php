    ...
    <div class="page">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <a href="{{route('semen-create')}}" class="btn btn-xs btn-success"> <i class="fa fa-plus"></i> Add Patients </a>
                 <i  onclick="printDiv('SEMEN EXAMINATION','semen')" class=" pull-right fa fa-print btn btn-square btn-info" style="margin-right: 10px;"> Print</i> <a href="javascript:void(0);" ></a>
                </div>
                <div class="card-body">
