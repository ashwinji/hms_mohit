        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="card-title"> PATIENTS LIST
                 <a href="{{route('generalblood-create')}}" class="btn btn-xs btn-success"> <i class="fa fa-plus"></i> Add Patients </a></div>
                <i  onclick="printDiv('GENERAL BLOOD EXAMINATION','generalblood')" class=" pull-right fa fa-print btn btn-square btn-info" style="margin-right: 10px;"> 
                Print</i> <a href="javascript:void(0);" ></a>
                </div>
                </div>
                <div class="card-body">
                <div class="table-responsive">
                <table id="generalblood" class="table table-striped table-bordered w-100">
                    <thead>
                    <tr>
...
<script type="text/javascript">
    ...
    oTable = $('#generalblood').DataTable({
    "processing": true,
    "serverSide": true,
    "ajax": "{{ route('sendgeneralblooddata') }}",
    "columns": [
    { data: 'id', name: 'id' },
    ...
    $('#generalblood').DataTable().ajax.reload();
    },
    error: function (data) {
