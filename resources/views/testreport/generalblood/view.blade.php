        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    </span> <i  onclick="printDiv('GENERAL BLOOD EXAMINATION','gbid')" class=" pull-right fa fa-print btn btn-square btn-info" style="margin-right: 10px;"> 
                ...
                <div class="label label-danger " style="text-color:#FF0000;text-align: center;">General Blood  BIOCHEMISTRY</div>
                </div>
                <div class="row">
